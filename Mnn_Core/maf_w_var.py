...
class MomentActivation():
    ...
    def grad_mean(self, ubar, sbar, cut_off=10, use_cache=True):
        ...
        grad_uv = grad_us.copy()
        grad_uv[indx2] = grad_us[indx2]/2/sbar[indx2]

        return grad_uu, grad_uv
    ...
    def grad_std(self, ubar, sbar, cut_off=10, use_cache=True):
        ...
        # ---- 
        grad_vu = grad_su.copy()
        grad_vu[indx2] = grad_vu[indx2]*2*self.v[indx2]
        grad_vv = grad_ss.copy()
        grad_vv[indx2] = grad_vv[indx2]/sbar[indx2]*self.v[indx2]
        

        return grad_vu, grad_vv
